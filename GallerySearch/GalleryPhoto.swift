...
class GalleryPhoto: Equatable {
    ...
    func galleryImageURL(_ size: String = "m") -> URL? {
    ...
    func loadLargeImage(_ completion: @escaping (Result<GalleryPhoto, Swift.Error>) -> Void) {
        guard let loadURL = galleryImageURL("b") else {
